...
nature of the system suggest the advantages and feasability of augmenting traditional eye trackers by combining them
...
classes in the problem. It is also expected  that using less face shapes to model one person reduces the complexity of
